...
public class Pagina1 extends javax.swing.JPanel {
    ...
    public Pagina1(long dni, String nombre, String apellido, boolean estado) {
        initComponents();
        this.dni = dni;
        this.nombre = nombre;
        ...
        this.cd = new ClienteData();
        this.cliente = cd.buscarClienteXDni(dni);
    ...
    private void initComponents() {
        ...
        jpContenedorLayout.setHorizontalGroup(
            ...
            .addGroup(jpContenedorLayout.createSequentialGroup()
                ...
                .addGap(35, 35, 35)
                .addComponent(jtfApellido, javax.swing.GroupLayout.PREFERRED_SIZE, 406, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(jpContenedorLayout.createSequentialGroup()
                .addGap(229, 229, 229)
    ...
    private void jtfApellidoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfApellidoFocusLost
        Pattern pat = Pattern.compile("^[^\\s][a-zA-ZÀ-ÿ]+\\s?$");
    ...
    private void jtfNombreFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfNombreFocusLost
        Pattern pat = Pattern.compile("^[^\\s][a-zA-ZÀ-ÿ\\s]{2,20}$");
        Matcher mat = pat.matcher(jtfNombre.getText());
        if (!jtfNombre.getText().equals("") && !mat.matches()) {
            JOptionPane.showMessageDialog(this, "Ingrese nombre con 4 a 20 cararacteres y solo letras");
            jtfNombre.requestFocus();
        }
    }//GEN-LAST:event_jtfNombreFocusLost

    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        if (jtfDni.getText().equals("") || jtfNombre.getText().equals("") || jtfApellido.getText().equals("")) {
            ...
            Pattern pat1 = Pattern.compile("^\\d{8}$");
            Matcher mat1 = pat1.matcher(jtfDni.getText());

            Pattern pat2 = Pattern.compile("^[^\\s][a-zA-ZÀ-ÿ\\s]{2,20}$");
            Matcher mat2 = pat2.matcher(jtfNombre.getText());

            if (mat.matches() && mat1.matches() && mat2.matches()) {

                long dni1 = Long.parseLong(jtfDni.getText());
                String nombre1 = jtfNombre.getText();
                String apellido1 = jtfApellido.getText();
                boolean estado1 = jcbEstado.isSelected();

                Cliente cliente1 = new Cliente(dni1, nombre1, apellido1, estado1);
    ...
    private void jbActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbActualizarActionPerformed
        if (jtfDni.getText().equals("") || jtfNombre.getText().equals("") || jtfApellido.getText().equals("")) {
            ...
            if (mat.matches() && mat1.matches() && mat2.matches()) {
                ...
                Cliente cliente1 = new Cliente(idCliente, dni1, nombre1, apellido1, estado1);

                cd.actualizarCliente(cliente1);
            }
        }
